  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
          <a class="btn btn-dark" href="?controller=empleado&method=usuarios">Regresar</a>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=empleado&method=crear_usuario" method="post" class="card col-10">
     <div class="row">
        ...
        <input type="text" placeholder="names lastnames" class="form-control col-10" name="nombre">
        </div>
      </div>
     <div class="row">
        ...
        <input type="email" placeholder="avila@example.com" class="form-control col-10" name="email">
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
        ...
        <input type="password" placeholder="*************" class="form-control col-10" name="password">
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
