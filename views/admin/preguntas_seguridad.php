<!-- Content Wrapper. Contains page content -->
  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
              <a class="btn btn-dark" href="?controller=admin&method=create_answer">Crear nueva pregunta de seguridad</a>
          </div>
          <div class="col-6">
              <a class="btn btn-dark" href="?controller=admin&method=preguntas_usuario">Preguntas de usuario</a>
          </div>
      </div>
              ...
              <!-- /.card-header -->
                ...
                <thead>
                 ...
                 <tr>
                    ...
                    <td><a href="?controller=admin&method=question_update&id_pregunta=<?=$question->id_pregunta?>"><i class="material-icons text-dark text-center">edit</i></a></td>
                  </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
