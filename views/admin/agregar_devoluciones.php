  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
          <a class="btn btn-dark" href="?controller=admin&method=devoluciones">Regresar</a>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=admin&method=insert_devolucion" method="post" class="card col-10">
     <div class="row">
