  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
              <a class="btn text-dark d-flex justify-content-start mx-2" href="?controller=admin&method=ingresar_producto"><i class="material-icons mx-3">person_add_alt_1</i><b>Ingresar producto</b></a>
          </div>
</div> 
