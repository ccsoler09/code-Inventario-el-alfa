  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
              <a class="btn text-dark d-flex justify-content-start mx-2" href="?controller=admin&method=agregar_proveedor"><i class="material-icons mx-3">person_add_alt_1</i><b> Crear proveedor nuevo</b></a>
          </div>
      </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php foreach(parent::proveedores() as $proveedor):?>
                  <tr>
                    ...
                    <td><a href="?controller=admin&method=update_proveedor&CodiProve=<?=$proveedor->CodiProve?>"><i class="material-icons text-dark">edit</i></a></td>
                    <td><a href="?controller=admin&method=state_proveedor&CodiProve=<?=$proveedor->CodiProve?>"><i class="material-icons text-dark">refresh</i></a></td>
                  </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
