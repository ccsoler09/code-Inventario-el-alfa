  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
          <a class="btn btn-dark" href="?controller=admin&method=profile&id=<?=$user->id?>">Regresar</a>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=admin&method=editar_respuesta_perfil" method="post" class="card col-10">
     <div class="row">
