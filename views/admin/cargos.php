  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
        <b>  
            <a class="d-flex justify-content-star text-dark " href="?controller=admin&method=agregar_cargos">
                <i class="material-icons mx-2">add</i> Agregar Cargo</a>
         </b>    
        </div>
      </div>
...
<div class="card">
              ...
              <!-- /.card-header -->
                ...
                <thead>
                 ...
                 <tr>
                    <td><?=$cargo->CodiCargo?></td>
                    <td><?=$cargo->CarDescripcion?></td>
                    <td><a href="?controller=admin&method=modificar_cargos&CodiCargo=<?=$cargo->CodiCargo?>"><i class="material-icons text-dark">edit</i></a></td>
                 </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
