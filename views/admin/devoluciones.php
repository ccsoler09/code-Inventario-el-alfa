  ...
  <div class="container">
    <div class="container">
      <div class="my-5 mx-5">
      <a class="btn text-dark d-flex justify-content-start mx-2" href="?controller=admin&method=agregar_devoluciones"><i class="material-icons mx-3 text-dark">assignment_return</i><b>Ingresar devolución</b></a>
      <div class="row">
      <div class="col-6">
         </div>
      </div>
