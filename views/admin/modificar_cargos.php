  ...
  <div class="row">
    <div class="col-4 mt-5"><h4>¡Actualizar cargos!</h4></div>
    <div class="col-4"></div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=admin&method=actualizar_cargo" method="post" class="card col-10">
     <div class="row">
        ...
        <input type="text" placeholder="nombre de categoria" class="form-control col-10" name="CarDescripcion" value="<?=$role->CarDescripcion?>">
        </div>
      </div>
      <input type="hidden" name="CodiCargo" value="<?=$role->CodiCargo?>">
