  ...
  <div class="row">
    <div class="col-4 mt-5"><h4>¡Registro de categorías!</h4></div>
    <div class="col-4"></div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=admin&method=crear_categoria" method="post" class="card col-10">
     <div class="row">
        ...
        <input type="text" placeholder="nombre de categoria" class="form-control col-10" name="NombCate">
        </div>
      </div>
      <div class="row">
        ...
        <div class="mx-1">Descripción:</div>
         <textarea name="Descripcion" class="form-control col-10" cols="30" rows="2" placeholder="Descripción de la categoría"></textarea> 
      </div>
      </div>
