  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
          <a class="btn btn-dark" href="?controller=admin&method=movimientos">Regresar</a>
        </div>
      </div>
              ...
              <div class="card-body" id="h1">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                    ...
                    <td><a href="?controller=admin&method=revertir_exit&id_movimiento=<?=$cantidad->id_movimiento?>"><i class="material-icons text-dark">restore</i></a></td> 
                 </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
