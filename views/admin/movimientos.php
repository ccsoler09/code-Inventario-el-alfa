              ...
              <div class="card-body" id="h1">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                    ...
                    <td><a href="?controller=admin&method=revertir&id_movimiento=<?=$cantidad->id_movimiento?>"><i class="material-icons text-dark">restore</i></a></td> 
                 </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
...
<!--end-->
      ...
      <a href="?controller=admin&method=movimientos_de_salida" class="btn btn-dark">Movimientos de salida</a> 
    </div>
  </div>
  </div>
  <!-- /.content-wrapper -->
