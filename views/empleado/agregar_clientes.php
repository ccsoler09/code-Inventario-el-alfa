  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
          <a class="btn btn-dark" href="?controller=empleado&method=clientes">Regresar</a>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-6 mt-5"><h4>¡Registro de clientes!</h4></div>
    <div class="col-1"></div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=empleado&method=crear_personas" method="post" class="card col-10">
     <div class="row">
        ...
        <input type="text" placeholder="names lastnames" class="form-control col-10" name="PersoNombres">
        </div>
      </div>
      <div class="row">
        ...
        <input type="email" placeholder="some@example.com" class="form-control col-10" name="Correo">
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
        ...
        <option selected disabled>Seleccione aquí su tipo de documento</option>
      ...
      <div class="row">
        ...
        <input type="text" placeholder="0000000000" class="form-control col-10" name="documento">
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
        ...
        <input type="text" placeholder="street #0 - 00 center park" class="form-control col-10" name="Direccion">
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
        ...
        <input type="text" placeholder="(0)00000000" class="form-control col-10" name="Telefono">
        </div>
      </div>
