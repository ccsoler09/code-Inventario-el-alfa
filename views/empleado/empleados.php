                    ...
                    <div>        
                        ...
                        <?php foreach(parent::empleados() as $prod):  ?>
                          <tr>
                           ...
                           <td class="center"><button id="button1" onclick="window.location.href='?controller=empleado&method=cambiar_estado&id_usuarios=<?=$prod->id_usuarios?>'" value="<?= $prod->usuario_estado?>" class="btn white-text waves-light">Inactivar</button></td>
                          </tr>
                         <?php endforeach; ?>
                        </tbody>        
                       </table>                  
