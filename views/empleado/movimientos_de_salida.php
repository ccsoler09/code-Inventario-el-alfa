  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
          <a class="btn btn-dark" href="?controller=empleado&method=movimientos">Regresar</a>
        </div>
      </div>
...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Historial de movimientos de salida</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body" id="h1">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                 <?php foreach(parent::movimientos_query_exit() as $cantidad):?>
                 <tr>
                    <td><?=$cantidad->fecha?></td>
                    <td><?=$cantidad->factura_id?></td>
                    <td><?=$cantidad->TipoMoviDescripcion?></td>
                    <td><?=$cantidad->nombre?></td>
                    <td><a href="?controller=empleado&method=revertir_exit&id_movimiento=<?=$cantidad->id_movimiento?>"><i class="material-icons text-dark">restore</i></a></td> 
                 </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
