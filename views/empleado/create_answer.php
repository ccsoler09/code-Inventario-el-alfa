  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=empleado&method=crear_pregunta" method="post" class="card col-10">
     <div class="row">
        ...
        <input type="text" placeholder="¿Question?" class="form-control col-10" name="pregunta">
        </div>
      </div>
