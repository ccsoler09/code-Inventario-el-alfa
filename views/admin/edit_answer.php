  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=admin&method=actualizar_pregunta" method="post" class="card col-10">
     <div class="row">
      ...
      <a href="?controller=admin&method=seguridades" class="btn btn-outline-dark mx-2">Cancelar</a>
