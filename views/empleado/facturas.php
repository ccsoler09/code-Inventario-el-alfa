  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
              <a class="btn text-dark d-flex justify-content-start mx-2" href="?controller=empleado&method=crear_factura"><i class="material-icons mx-3">person_add_alt_1</i><b>Agregar factura nueva</b></a>
          </div>
      </div>
              ...
              <div class="card-body" id="h1">
                ...
                <thead>
                 ...
                 <tr>
                    ...
                    <td><a class="btn btn-white" target="_blank" href="?controller=empleado&method=fpdf&id_factura=<?=$facturas->id_factura?>"><i class="material-icons">get_app</i></a></td>
                  </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
