  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
          <a class="btn btn-dark" href="?controller=empleado&method=devoluciones">Regresar</a>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=empleado&method=insert_devolucion" method="post" class="card col-10">
     <div class="row">
        <div class="col-2 mx-5">
        </div>
        <div class="col-10 my-3 d-flex justify-content-center align-items-center">
        <div class="mx-3">Cliente:</div>
        <select name="persona_id" id="" class="form-control col-10">
          <option disabled selected>Selecciona aquí al cliente</option>
      ...
      <div class="row">
       ...
       <div class="row">
        ...
        <textarea placeholder="Descripción" class="form-control col-10" name="descripcion"></textarea>
        </div>
      </div>
