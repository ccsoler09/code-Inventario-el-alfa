  ...
  <div class="container">
    <div class="container">
      ...
      <div class="row">
          <div class="col-6">
              <a class="btn text-dark d-flex justify-content-start mx-2" href="?controller=admin&method=agregar_clientes"><i class="material-icons mx-3">person_add_alt_1</i><b>Agregar nuevo cliente</b></a>
          </div>
      </div>
              ...
              <div class="card-body" id="h1">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                    ...
                    <td><a href="?controller=admin&method=editar_clientes&id_persona=<?=$persona->id_persona?>"><i class="material-icons text-dark">edit</i></a></td>
                  </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
