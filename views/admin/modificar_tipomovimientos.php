  ...
  <div class="row">
    <div class="col-4 mt-5"><h4>¡Modificar tipo de movimiento!</h4></div>
    <div class="col-4"></div>
  ...
  <div class="row">
    <div class="col-12">
     <center>
     <form action="?controller=admin&method=actualizar_tipomovimiento" method="post" class="card col-12">
     <div class="row">
        ...
        <input type="text" placeholder="Nombre del tipo de movimiento" class="form-control col-10" name="TipoMoviDescripcion" value="<?=$move->TipoMoviDescripcion?>">
        </div>
      </div>
      <input type="hidden" name="Idmovi"  value="<?=$move->Idmovi?>">
