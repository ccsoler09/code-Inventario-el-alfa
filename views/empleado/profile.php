  ...
  <div class="row">
    <div class="col-12">
     ...
     <div class="row">
      ...
      <a class="btn btn-outline-dark mx-2" href="?controller=empleado&method=edit_profile&id=<?=$user->id?>">Editar</a>
      </div>
     </form>
     </center>
    </div>
  ...
  <div class="row">
    <div class="col-12">
     ...
     <div class="row">
      ...
      <div class="d-flex justify-content-center mb-3">
      <a class="btn btn-outline-dark mx-2" href="?controller=empleado&method=edit_profile_question&id=<?=$user->id?>">Editar</a>
      </div>
     </form>
     </center>
    </div>
...
<div class="container">
    ...
    <a class="btn btn-dark" href="?controller=empleado&method=change_passwords&id=<?=$user->id?>">Cambiar contraseñas</a>
    </div>
</div>
      </div>
    </div>
